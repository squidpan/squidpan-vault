...
tags:
  - "clippings"
---
This page is about the current Swagger Editor. If you’re looking for Swagger Editor Next (beta) (otherwise known as `SwaggerEditor@5` ) docs, visit [Swagger Editor Next (beta)](https://swagger.io/docs/open-source-tools/swagger-editor-next).
...
Only **Swagger Editor Next** supports [OpenAPI 3.1.0](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md). SwaggerEditor@4 will not receive OpenAPI 3.1.0 support and is considered legacy at this point. The plan is to continually migrate fully to SwaggerEditor@5 and deprecate the SwaggerEditor@4 in the future.
...
- [Importing your OpenAPI document](https://swagger.io/docs/open-source-tools/swagger-editor/docs/import.md)
...
By default [swagger-editor@4](https://www.npmjs.com/package/swagger-editor) npm package comes with latest version of [React@18](https://react.dev/blog/2022/03/29/react-v18). It’s possible to use *swagger-editor@4* npm package with older version of React.

Let’s say my application integrates with *swagger-editor@4* npm package and uses [React@17.0.2](https://www.npmjs.com/package/react/v/17.0.2).
...
Please disclose any security-related issues or vulnerabilities by emailing [security@swagger.io](https://swagger.io/docs/open-source-tools/swagger-editor/), instead of using the public issue tracker.
